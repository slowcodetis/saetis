...
$texto2 = '  Asímismo, recordar que para el día de la firma del contrato que se realizará el día <b>'. $fecha . '</b> a horas <b>'.$hora.'</b> en <b>'.$lugar .'</b>; se requiere de una copia física de la Boleta de Garantía, emitida a favor de TIS por parte de <b>'.$nombreCGE.'</b>.';
                                                ...
                                                if (strcasecmp($nombreDoc, $nombDoc)!=0) {
                                                    ...
                                                    $HoraRegistrado = date('h:i:s');
                                                        //$script1 = "INSERT INTO registro(NOMBRE_U, TIPO_T,ESTADO_E,NOMBRE_R,FECHA_R,HORA_R) VALUES('$nombreUA','documento requerido','Habilitado','orden de cambio 1','$FechaRegistrado', '$HoraRegistrado')";
                                                        //echo"<script type=\"text/javascript\">alert('$script1');</script>";                                                        
                                                    ...
                                                    $FechaInicioEntrega = "2015-06-01";
                                                    $FechaFinalEntrega = "2015-06-20";
                                                    $HoraInicioEntrega = "00:00";
                                                    $HoraFinalEntrega = "23:30";
                                                    $DescripcionDocumento = "Orden de Cambio";

                                                    $InsertarPlazo = $conexion->query("INSERT INTO plazo(`ID_R`, `FECHA_INICIO_PL`, `FECHA_FIN_PL`, `HORA_INICIO_PL`, `HORA_FIN_PL`) VALUES('$id','$FechaInicioEntrega','$FechaFinalEntrega','$HoraInicioEntrega','$HoraFinalEntrega')");

                                                        $script1 = "INSERT INTO plazo(`ID_R`, `FECHA_INICIO_PL`, `FECHA_FIN_PL`, `HORA_INICIO_PL`, `HORA_FIN_PL`) VALUES('$id','$FechaInicioEntrega','$FechaFinalEntrega','$HoraInicioEntrega','$HoraFinalEntrega')";
                                                        
                                                    $InsertarDescripcion  = $conexion->query("INSERT INTO descripcion(`ID_R`, `DESCRIPCION_D`) VALUES('$id', '$DescripcionDocumento')");
                                                    //$proyecto_id = $conexion->query("SELECT proyecto.CODIGO_P FROM proyecto, inscripcion_proyecto WHERE NOMBRE_U='$nombreUGE' AND proyecto.CODIGO_P = inscripcion_proyecto.CODIGO_P");
                                                    //$row = $SeleccionDocumentoID->fetchObject();
                                                    //$p_id = $row -> CODIGO_P;

                                                        //echo"<script type=\"text/javascript\">alert('falla en la ultima tabla');</script>";
                                                        
                                                    $InsertarDocumentoOrdenCambio = $conexion->query("INSERT INTO documento_requerido_oc(`usuario_id`, `registro_id`) VALUES ('$nombreUGE','$id')");
