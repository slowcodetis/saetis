                    ...
                    <div class="col-lg-6" >
                        ...
                        <?php
                            ...
                            if (!is_array($inscrip)) {
                                ...
                                $consFechas = $conexion->consulta("SELECT FECHA_INICIO_PL, FECHA_FIN_PL, HORA_INICIO_PL, HORA_FIN_PL FROM documento_requerido_oc, registro, plazo WHERE documento_requerido_oc.USUARIO_ID='$uActivo' AND documento_requerido_oc.REGISTRO_ID = registro.ID_R AND registro.ID_R = plazo.ID_R AND registro.NOMBRE_R = '$Doc'");
