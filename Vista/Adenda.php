        ...
        <div id="page-wrapper">
            <form id = "ordenc" method = "post" action="" role="form" enctype="multipart/data-form" onsubmit="return validarCampos(ordenc)">
                <div class ="form-horizontal">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="page-header">Emitir Adenda</h2>    
                            </br>     
                        </div>
                    </div><!-- /.row -->
                    ...
                    <div class="form-group" >
                        <label class="col-sm-2 control-label">Parrafos</label>
                    ...
                    <div class   ="form-group">
                        <div class   ="col-sm-8">
                            <input class ="btn btn-primary" type="submit" value= "Generar" id= "enviar" name="enviar" onclick ="this.form.action='../Controlador/GeneradorAdenda.php?id=0'"></input> &nbsp;&nbsp;                      
                        </div>
                    </div><!--end/submit-->
                </div> 
            </form>  
